...
public class LayoutData {
    ...
    public ArrayList<ColumnData> options = new ArrayList();
        ...
        try {
            ...
            while (line != null) {
                ...
                if (line.startsWith(NEW_COLUMN)) {
                    if (columnData2 != null) {
                        this.options.add(columnData2);
                        this.maxColItemCount = Math.max(this.maxColItemCount, columnData2.options.size() - 1);
                    }
...
//                    try {
                        if (line.startsWith(SPACE) || line.isEmpty() || line.charAt(0) == ',') {
                            ...
                            columnData2.addOption(new OptionData(vals[0], vals[language.getIndex()], vals[3], vals[4]));
                            columnData = columnData2;
                        }
